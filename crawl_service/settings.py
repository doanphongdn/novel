...
BACKBLAZE_QUALITY_IMG = int(os.environ.get('BACKBLAZE_QUALITY_IMG', 75))
BACKBLAZE_COMPRESS_QUALITY_IMG = os.environ.get('BACKBLAZE_COMPRESS_QUALITY_IMG', 'True').lower() == 'true'
